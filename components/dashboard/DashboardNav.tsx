...
export function DashboardSidebar({ unreadInquiries = 0 }: NavProps) {
        ...
        {sidebarLinks.map((link) => {
          ...
          return (
            ...
            >
              ...
              {badge > 0 && (
                <span className="absolute -top-1 right-0 bg-red-500 text-white text-[9px] font-bold min-w-[16px] h-4 rounded-full flex items-center justify-center px-1">
                  {badge}
                </span>
              )}
            </Link>
